...
public class ShitPostBot {
    ...
    public static void randomShit(){
        filetemplatenum = random.nextInt(10) + 1;
        filesourcenum = random.nextInt(219) + 1;
        filesourcesize = new File("F:\\ShitPostBot\\Windows\\Templates\\Template" + filetemplatenum + "\\TemplateSourceSize.jpg");
        filetemplate = new File("F:\\ShitPostBot\\Windows\\Templates\\Template" + filetemplatenum + "\\Template.jpg");
        coordinates = new File("F:\\ShitPostBot\\Windows\\Templates\\Template" + filetemplatenum + "\\TemplateCoords.txt");
        filesource = new File("F:\\ShitPostBot\\Windows\\Sources\\Source (" + filesourcenum + ").jpg");
    ...
    public static BufferedImage layer(Image source, Image template, int sourcex, int sourcey) {
        ...
        if(coordslist[2] > 0) {
            fileoverlay = new File(("F:\\ShitPostBot\\Windows\\Templates\\Template" + filetemplatenum + "\\Overlay.png"));
    ...
    public static void makeShitPost() {
